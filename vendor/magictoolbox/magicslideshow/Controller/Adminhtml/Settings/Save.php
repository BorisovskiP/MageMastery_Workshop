...
class Save extends \MagicToolbox\MagicSlideshow\Controller\Adminhtml\Settings
{
    /**
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\MagicToolbox\MagicSlideshow\Model\Config::class);
