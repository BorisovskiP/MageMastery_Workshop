...
class InstallData implements \Magento\Framework\Setup\InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [];
        $moduleEtcPath = $this->_modulesReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR, 'MagicToolbox_MagicSlideshow');
        ...
        if (!empty($data) && $setup->tableExists('magicslideshow_config')) {
            $tableName = $setup->getTable('magicslideshow_config');
