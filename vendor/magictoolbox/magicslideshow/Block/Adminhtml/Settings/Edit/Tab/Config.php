...
namespace MagicToolbox\MagicSlideshow\Block\Adminhtml\Settings\Edit\Tab;

use Magento\Backend\Block\Widget\Form\Generic;
use MagicToolbox\MagicSlideshow\Helper\Data;
use MagicToolbox\MagicSlideshow\Helper\UpgradeData;
...
class Config extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * Upgrade data helper
     *
     * @var \MagicToolbox\MagicSlideshow\Helper\UpgradeData
     */
     ...
     * @param \MagicToolbox\MagicSlideshow\Helper\UpgradeData $upgradeDataHelper
     * @param array $data
     */
    public function __construct(
        ...
        \MagicToolbox\MagicSlideshow\Helper\UpgradeData $upgradeDataHelper,
        array $data = []
    ) {
    ...
    protected function _prepareLayout()
    {
        ...
        if (is_null($fieldsetElementRenderer)) {
            $fieldsetElementRenderer = $this->getLayout()->createBlock(
                'MagicToolbox\MagicSlideshow\Block\Adminhtml\Settings\Edit\Form\Renderer\Fieldset\Element',
