...
class Version extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _construct()
    {
        ...
        $this->dataHelper = $this->objectManager->get(\MagicToolbox\MagicSlideshow\Helper\Data::class);
    }
    ...
    {
        $version = $this->dataHelper->getModuleVersion('MagicToolbox_MagicSlideshow');
