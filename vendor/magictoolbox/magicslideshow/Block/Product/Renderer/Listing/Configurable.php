...
namespace MagicToolbox\MagicSlideshow\Block\Product\Renderer\Listing;
...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Listing\Configurable
{
     ...
     */
    const MAGICTOOLBOX_MEDIA_CALLBACK_ACTION = 'magicslideshow/ajax/media';

    /**
     * @var \MagicToolbox\MagicSlideshow\Helper\ConfigurableData
     */
    protected $helper;
    ...
    protected function _construct()
    {
        ...
        $this->helper = $objectManager->get(\MagicToolbox\MagicSlideshow\Helper\ConfigurableData::class);
    ...
    protected function _getAdditionalConfig()
    {
        ...
        if ($data && $data['current-renderer'] == 'configurable.magicslideshow') {
            $config['magictoolbox'] = [
